    ...
    <div class="container card-content">
        <div class="card shadow mb-4">
            ...
            <div class="container-fluid mt-4 mb-4">
                <form method="POST" action="{{ route('kelola-data-arsip-lama-store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-lg-12">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Masukan tempat lahir pria"
                                    name="tempat_lahir_pria" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" placeholder="Masukan nama pria"
                                    name="tanggal_lahir_pria"required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Masukan nama warga negara pria"
                                    name="warga_negara_pria" required>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" placeholder="Masukan nama wanita"
                                    name="tanggal_lahir_wanita" required>
